                            ...
                            <div className={styles["flex"]}>
                                <Link target="_blank" href='https://dober.me/web/index.html'>
                                    <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path className={styles["svg-color"]} d="M12 22H15.6364M12 22L12.4545 18.3636H15.1818L15.6364 22M12 22H9.27273M15.6364 22H18.3636M3.81818 2H23.8182C24.3004 2 24.7629 2.19156 25.1038 2.53253C25.4448 2.87351 25.6364 3.33597 25.6364 3.81818V16.5455C25.6364 17.0277 25.4448 17.4901 25.1038 17.8311C24.7629 18.1721 24.3004 18.3636 23.8182 18.3636H3.81818C3.33597 18.3636 2.87351 18.1721 2.53253 17.8311C2.19156 17.4901 2 17.0277 2 16.5455V3.81818C2 3.33597 2.19156 2.87351 2.53253 2.53253C2.87351 2.19156 3.33597 2 3.81818 2Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <rect className={styles["svg-color"]} x="12" y="19" width="3" height="3" fill=""/>
                                    </svg>
                                </Link>
                            </div>
                            <div>
